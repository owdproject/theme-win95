...
<template>
  <div>
    ...
    <!--
    <Divider layout="vertical" />
    <Button variant="text" @click="$emit('undo')">
      <div class="p-button-image">
        <img
          class="mx-auto"
          src="data:image/gif;base64,"
          style="width: 19px"
        />
      </div>
      {{$t('apps.explorer.toolbar.undo')}}
    </Button>
    -->
    <Button variant="text" @click="$emit('delete')">
      <div class="p-button-image">
        <img
          class="mx-auto"
