...
<template>
  <Sheet border class="owd-system-bar__menu">
    ...
    <List class="owd-system-bar__menu__list">
      <template
          v-for="listItem of systemBarMenu"
      >
